        ...
        </Link>
        {
          ...
          <div className='flex items-center gap-2 sm:gap-3'>
            ...
            transition-all duration-700'>
              ...
              <img className='w-5' src={assets.credit_star} alt="credit-logo" /> 

              <p onClick={()=> navigate('/buy')} className='text-xs sm:text-sm font-medium
              text-gray-600'>
            ...
            <div className='relative group'>
                ...
                <img src={assets.profile_icon} alt="pfp" className='w-10
                drop-shadow'/>
